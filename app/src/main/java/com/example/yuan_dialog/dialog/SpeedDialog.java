...
public class SpeedDialog extends Dialog implements View.OnClickListener {
    ...
    public static final int BOTTOM_SELECT_TYPE = 1; //底部选择框
    public static final int PROGRESS_TYPE = 2;//加载框
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mDialogType == BOTTOM_SELECT_TYPE){
            ...
            mTitleTv = parentPanel.findViewById(R.id.dialogTitle);        //标题
            mMessageTv = parentPanel.findViewById(R.id.dialogText);    //内容
            mCancelBtn = parentPanel.findViewById(R.id.dialogCancel);    //取消
            mSureBtn = parentPanel.findViewById(R.id.dialogSure);    //确定
    ...
    public void show() {
        ...
        if(mDialogType == BOTTOM_SELECT_TYPE) {
            ...
            if(mDialogType == NORMAL_TYPE){
                lp.height= (int) (screenWidth * 0.5);
            }else {
